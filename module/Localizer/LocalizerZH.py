...
class LocalizerZH:
    ...
    response_checker_line_error_cjk: str = "汉字残留"
    ...
    proofreading_page_warning_cjk: str = "汉字残留"
    ...
    expert_settings_page_response_check_cjk_residue: str = "汉字残留检查"
