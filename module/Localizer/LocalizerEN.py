...
class LocalizerEN(LocalizerZH):
    ...
    issue_cjk_residue: str = "CJK Residue"
    close: str = "Close"
    alert: str = "Alert"
    warning: str = "Warning"
    confirm: str = "Confirm"
    ...
    response_checker_line_error_cjk: str = "CJK Residue"
    ...
    proofreading_page_warning_cjk: str = "CJK Residue"
    ...
    expert_settings_page_response_check_cjk_residue: str = "CJK Residue Check"
